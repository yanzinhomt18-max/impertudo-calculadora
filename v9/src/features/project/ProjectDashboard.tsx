...
export default function ProjectDashboard() {
  const { project, updateMeta, removeCalculation, updatePricing, setCashDiscountPct, setPaymentMethod, setChecklistItem, resetProject } = useProject()
