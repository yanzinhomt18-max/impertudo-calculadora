...
const products = { ...meta, products: chunks.flat() }
...
console.log(`Banco V9 válido: ${products.products.length} produtos, ${categoryIds.size} categorias, ${areaIds.size} ambientes, ${systems.systems.length} sistemas.`)
